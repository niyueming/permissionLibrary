...
public class NPermissionFragment extends Fragment implements IPermissionConstant,NPermissionListener {
    private final static String TAG = NPermissionFragment.class.getSimpleName();
    @Override
